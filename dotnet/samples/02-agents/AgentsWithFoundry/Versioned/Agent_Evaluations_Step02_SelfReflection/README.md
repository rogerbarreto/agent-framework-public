...
```powershell
cd dotnet/samples/02-agents/AgentsWithFoundry/Versioned/Agent_Evaluations_Step02_SelfReflection
dotnet run
```
...
3. Explore the Safety Evaluation sample (Agent_Evaluations_Step01_RedTeaming) for content safety assessment
