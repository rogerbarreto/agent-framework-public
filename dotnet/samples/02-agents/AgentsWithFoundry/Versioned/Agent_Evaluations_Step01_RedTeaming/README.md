...
```powershell
cd dotnet/samples/02-agents/AgentsWithFoundry/Versioned/Agent_Evaluations_Step01_RedTeaming
dotnet run
```
...
2. Explore the Self-Reflection sample (Agent_Evaluations_Step02_SelfReflection) for quality assessment
