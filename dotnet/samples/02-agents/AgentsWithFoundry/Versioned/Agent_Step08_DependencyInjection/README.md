...
- Using `ChatClientAgent` with dependency injection
...
Navigate to the AgentsWithFoundry/Versioned sample directory and run:
...
2. Register `ChatClientAgent` and `AIAgent` as services
