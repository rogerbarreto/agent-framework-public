...
| [Computer use](./Agent_Step15_ComputerUse/) | Computer use tool (preview `computer_use_preview`) |
...
| [Computer use (GA)](./Agent_Step27_ComputerUseGA/) | GA `computer` tool with batched actions (runs on public OpenAI until Foundry supports it) |
