...
For the generally available (GA) `computer` tool, created with the parameterless `FoundryAITool.CreateComputerTool()` and returning batched actions, see [Agent_Step27_ComputerUse](../Agent_Step27_ComputerUse/).
