...
> **See also**: [Memory Search with Foundry Agents](../AgentsWithFoundry/Responses/Agent_Step22_MemorySearch/) - demonstrates using the built-in Memory Search tool with Azure Foundry agents.
