...
public sealed class FoundryResponsesAgent : AIAgent
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="FoundryResponsesAgent"/> class using environment variables for configuration.
    /// </summary>
    ...
    public FoundryResponsesAgent(
        ...
        : this(
              ...
              Environment.GetEnvironmentVariable(ModelDeploymentEnvVar)
                ?? throw new InvalidOperationException($"Environment variable '{ModelDeploymentEnvVar}' is not set."),
              clientOptions: null,
              instructions,
              name,
              description,
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="FoundryResponsesAgent"/> class.
    /// </summary>
