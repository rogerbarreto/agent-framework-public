...
public class FoundryAgentRunPreviousResponseTests() : RunTests<FoundryAgentFixture>(() => new())
{
...
public class FoundryAgentRunConversationTests() : RunTests<FoundryAgentFixture>(() => new())
{
